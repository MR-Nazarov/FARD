"""
Score the DnCNN motion+ghosting robustness sweep via the Post_processing tester
and merge into motion_corrupt_metrics_all_dncnn.csv (BYTE-identical schema to
...
the model. DnCNN's saved pred is transposed (218x182) vs GT (182x218); the group
...
PROJECT = 'BRATS/motion_corrupt_dncnn'
GROUPS = [1, 2, 3, 4, 5, 6]
...
def main():
    ...
    confs = sorted(corr)
    out_path = 'motion_corrupt_metrics_all_dncnn.csv'
